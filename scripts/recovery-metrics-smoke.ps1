...
foreach($name in @("logitrack_outbox_backlog","logitrack_outbox_oldest_age_seconds","logitrack_dlq_backlog","logitrack_outbox_retries_total","logitrack_dlq_replays_total","logitrack_route_analysis_total","logitrack_report_pdf_total","logitrack_retention_deleted_total","logitrack_retention_failures_total","http_server_requests_seconds_bucket","kafka_consumer_coordinator_assigned_partitions")){
