...
def main() -> None:
    ...
    required = (
        ...
        'sleep "$((attempt * 2))"',
        "was not readable after bounded registry propagation retries",
        ...
        "Install pinned provenance verifier",
