...
public class AlertController {
    ...
    @GetMapping public List<DeliveryAlert> list(@RequestParam(defaultValue="200") int limit){return repository.findAll(PageRequest.of(0,validLimit(limit),stableSort())).getContent();}
    @GetMapping("/page") public AlertPage page(@RequestParam(defaultValue="0") int page,
        ...
        var result=repository.findAll(PageRequest.of(page,validLimit(size),stableSort()));
