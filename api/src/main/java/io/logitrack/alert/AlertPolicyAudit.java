...
public class AlertPolicyAudit {
    ...
    public AlertPolicyAudit(AlertPolicy policy,String actor){id=UUID.randomUUID();policyId=policy.getId();vehicleId=policy.getVehicleId();
        ...
        this.actor=actor;occurredAt=Instant.now();}
    ...
    public String getActor(){return actor;} public Instant getOccurredAt(){return occurredAt;}
}
