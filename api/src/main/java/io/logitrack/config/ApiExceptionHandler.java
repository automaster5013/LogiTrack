...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(HttpMessageNotReadableException.class) ResponseEntity<ApiError> malformed(HttpMessageNotReadableException error,HttpServletRequest request){return causedBy(error,RequestBodyLimitFilter.RequestBodyTooLargeException.class)?response(HttpStatus.PAYLOAD_TOO_LARGE,"Request body is too large",request):response(HttpStatus.BAD_REQUEST,"Malformed request body",request);}
