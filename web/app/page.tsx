...
export default function Home(){
 ...
 const scopedItems=fleetScope==="LIVE"?liveItems:fleetScope==="ATTENTION"?liveItems.filter(item=>attentionIds.has(item.id)):fleetScope==="STALE"?liveItems.filter(item=>staleIds.has(item.id)):items;
